...
const Paciente =({paciente, setPaciente, eliminarPaciente}) =>{
    ...
    //Cuando el usuario haga click en el boton de eliminar
    const handleEliminar = () => {
        const respuesta = confirm('Deseas eliminar este paciente?'); //Alert de confirmación
        ...
        <div className="mx-5 my-10  bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-between mt-10">
                ...
                <button
                    ...
                    onClick={handleEliminar} //Sin paréntesis porque no necesito llamar a la función directamente
                    >Eliminar</button>
            </div>
        </div> 
